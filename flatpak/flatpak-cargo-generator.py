#!/usr/bin/env python3
#
# Vendored, unmodified, from flatpak-builder-tools:
#   https://github.com/flatpak/flatpak-builder-tools
#   path:   cargo/flatpak-cargo-generator.py
#   commit: f03a673abe6ce189cea1c2857e2b44af2dd79d1f
#   license: MIT (see __license__ below; upstream LICENSE at repo root)
#
# Kept in-tree so `flatpak/cargo-sources.json` can always be regenerated
# without a live network fetch of a mutable branch. Update by re-copying a
# newer pinned commit; do not edit locally.
#
# /// script
# requires-python = ">=3.9"
# dependencies = [
